...
$current_path = '../../../../uploads/tinyMCE/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../uploads/tinyMCE_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
